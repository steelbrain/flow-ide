...
export default {
    ...
    const linter = {
      ...
      lint: async (textEditor) => {
        ...
        return semver.gte(version, '0.66.0')
          ? this.lintV2(textEditor, fileDirectory, executable)
          : this.lintV1(textEditor, fileDirectory, executable)
      },
    }
    return linter
  },
  async lintV1(textEditor: TextEditor, fileDirectory: string, executable: string) {
    let result
    try {
      ...
      handleError(error)
      return this.lintV1(textEditor, fileDirectory, executable)
    }
  ...
  async lintV2(textEditor: TextEditor, fileDirectory: string, executable: string) {
    let result
    try {
