...
export default {
  ...
  provideLinter(): Object[] {
    return [this.provideStatusLinter(), this.provideStatusLinterV2(), this.provideCoverageLinter()]
  },
  ...
  provideStatusLinterV2(): Object {
    const linter = {
      ...
      lint: async (textEditor) => {
        ...
        return LinterV2.toLinterMessages(result)
      },
    }
    return linter
  },
